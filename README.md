...
## AI assistants (Codex, Cursor, Antigravity, VS Code)

This repository is maintained with multiple AI tools. **Do not skip the handoff file.**
...
- 🔐 **Immutable Ownership** - Hardened ID-based privilege isolation (Decoupled from Firestore role)
- 🚀 **Zero-Latency Taps** - `touch-action` optimized for instant mobile interaction
- 🌗 **Live Blur & Solid Mode** - Premium UI with GPU-optimized blur + fallback
- 🔐 **Zero-Read Auth** - High-speed Secure Owner, Admin, and Student portals via Custom Claims
- 🌐 **Full RTL Support** - Seamless Arabic language integration
- 📊 **Real-time Analytics** - Live presence tracking and resource management
...
| **Firebase 12.7** | Scalable Backend & Hosting |
| **Framer Motion** | GPU-optimized smooth animations |
| **Presence RTDB** | Real-time User Tracking |
...
```
src/
├── app/                 # Next.js App Router & Legal Pages
├── components/          # Features, Layout, and UI Library
├── contexts/            # Global State (Auth, Theme, Lang)
├── hooks/               # Custom React Logic
├── lib/                 # Core utilities & Firebase SDK
...
- **Environment Isolation**: No secrets are stored in the codebase.
- **Vulnerability Scanning**: Automated dependency checks via CodeQL.
- **Reporting**: If you discover a security vulnerability, please report it via the Support Chat in the platform.
...
© 2026 Obour Academic Hub - Developed by **Sir Ahmed**
