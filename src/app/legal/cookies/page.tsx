    ...
    <AppShell>
      <div className="max-w-4xl mx-auto p-8 space-y-8 animate-in fade-in duration-500">
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            {language === "ar"
              ? "يمكنك حذف ملفات تعريف الارتباط في أي وقت من إعدادات المتصفح الخاص بك، ولكن قد يؤثر ذلك على عمل بعض ميزات الموقع مثل تسجيل الدخول التلقائي."
              : "You can clear cookies at any time from your browser settings, but this may affect features like automatic login."}
          </p>
        </section>
      </div>
    </AppShell>
