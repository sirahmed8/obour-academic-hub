        ...
        <div className="flex items-center gap-2 border-l border-primary-foreground/30 pl-4">
          ...
          <div className="relative">
            <button
              ...
              className="px-3 py-2 bg-primary-foreground/20 hover:bg-primary-foreground/30 rounded-lg transition-colors flex items-center gap-2"
          ...
          <button
            ...
            className="px-3 py-2 bg-destructive hover:bg-destructive/90 rounded-lg transition-colors text-sm"
          >
