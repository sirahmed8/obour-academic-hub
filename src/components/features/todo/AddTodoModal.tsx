      ...
      >
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                className="w-full bg-muted/50 border border-border rounded-xl px-2 py-1.5 h-[38px] text-xs outline-none focus:ring-2 focus:ring-primary/20"
              />
            </div>
          </div>
        ...
        <div className="p-4 border-t border-border flex justify-end gap-3 bg-muted/20">
          ...
          <button
            ...
            className="px-6 py-2 text-sm font-medium bg-primary text-primary-foreground rounded-xl shadow-lg shadow-primary/25 hover:shadow-xl hover:shadow-primary/30 transition-all active:scale-95 disabled:opacity-50 disabled:pointer-events-none"
          >
            {isSubmitting
              ? language === "ar"
                ? "جاري الحفظ..."
