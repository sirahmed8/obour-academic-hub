    ...
    <div className="min-h-screen w-full flex flex-col items-center justify-center bg-black relative overflow-hidden">
      ...
      <ScaleIn className="w-full max-w-md relative z-10 p-6">
        <div className="relative group">
          ...
          <div className="absolute -inset-1 bg-gradient-to-r from-primary/30 to-purple-600/30 rounded-[2rem] blur-xl opacity-75 group-hover:opacity-100 transition duration-1000 group-hover:duration-200" />
          ...
          <div className="relative bg-black/40 backdrop-blur-2xl backdrop-saturate-150 border border-white/10 rounded-[1.75rem] p-8 md:p-12 shadow-2xl ring-1 ring-white/5">
            <div className="flex flex-col items-center justify-center gap-8 mb-10">
              ...
              <div className="text-center space-y-3">
                <h1 className="text-4xl font-black tracking-tight text-transparent bg-clip-text bg-gradient-to-br from-white via-white/90 to-white/60 drop-shadow-sm font-harman">
            ...
            >
              ...
              >
                {/* Shimmer Effect */}
                <div className="absolute inset-0 -translate-x-full group-hover/btn:translate-x-full hover:duration-1000 duration-[1500ms] bg-gradient-to-r from-transparent via-black/5 to-transparent z-10 transition-transform ease-in-out" />
