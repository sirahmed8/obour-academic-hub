      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="glass-container fixed bottom-24 right-6 z-50 w-[380px] max-w-[calc(100vw-3rem)] h-[600px] max-h-[calc(100vh-8rem)] bg-white/70 dark:bg-black/40 backdrop-blur-xl backdrop-saturate-150 border border-primary/10 dark:border-white/10 rounded-2xl shadow-2xl flex flex-col overflow-hidden origin-bottom-right"
          >
            <ChatHeader
              mode={mode}
              setMode={setMode}
