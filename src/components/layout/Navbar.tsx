...
export function Navbar({ onMenuClick }: NavbarProps) {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 h-16 z-50 transition-all duration-300 overflow-visible">
      {/* Visual Background Layer - Full Glass (EXACT Sidebar Pattern) */}
      <div className="absolute inset-0 glass-premium border-b border-white/10 dark:border-white/5 shadow-2xl rounded-b-2xl" />
      {/* Content Layer */}
