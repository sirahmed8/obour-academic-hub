...
export function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed top-0 h-full w-[85vw] max-w-[280px] lg:max-w-none lg:w-72 z-[999] transition-transform duration-500 cubic-bezier(0.32, 0.72, 0, 1) ease-in-out lg:shadow-none mr-0 overflow-hidden",
