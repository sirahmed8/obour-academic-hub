        ...
        <div className="flex flex-col h-full">
          ...
          {user && (
            <div className="p-4 border-t border-border bg-muted/30">
              ...
              <button 
                onClick={logout}
                className="w-full flex items-center justify-center gap-2 px-4 py-2 text-sm text-destructive bg-destructive/10 hover:bg-destructive/20 rounded-lg transition-colors font-medium"
              >
                <LogOut size={16} />
                {t('nav.logout')}
              </button>
